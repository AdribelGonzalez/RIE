...
<style type="text/css">
	...
	<?php if($flatsome_opt['color_secondary']){?> 
		...
		/* -- background -- */
		.label-sale.menu-item a:after,ul.page-numbers li > span,.mini-cart:hover .custom-cart-count,.callout .inner,.button.secondary,.button.checkout,#submit.secondary, button.secondary, .button.secondary, input[type="submit"].secondary{background-color: <?php echo $flatsome_opt['color_secondary'] ?>}
		/* -- borders -- */
