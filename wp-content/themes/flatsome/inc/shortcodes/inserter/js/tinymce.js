			...
			ed.add({
				...
				onclick: function () {
					...
					if(id == "product_pinterest") {
						tinyMCE.activeEditor.selection.setContent('[products_pinterest_style cat="category-slug" columns="4"]');
					}

					if(id == "product_slider_bestseller") {
						tinyMCE.activeEditor.selection.setContent('[ux_bestseller_products columns="4" title="Check our bestsellers!"]');
					}

					if(id == "product_slider_featured") {
						tinyMCE.activeEditor.selection.setContent('[ux_featured_products columns="4" title="Check our Featured products!"]');
					}
