...
<div id="order_review">
	...
	<div id="payment">
		...
		<h3><?php _e('Payment method', 'flatsome' ); ?></h3>
		...
		<div class="form-row place-order">
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="button secondary large expand" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' );
			?>
